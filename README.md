...
- Run `scripts/init-project.sh` twice against a scratch Git repo and confirm no duplicated content (see [Troubleshooting](docs/TROUBLESHOOTING.md) for the exact steps).
